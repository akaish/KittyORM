 ...
 */
public abstract class  KittyDatabase<M extends KittyModel, D extends KittyMapper<M>> {
     ...
     */
    protected  Map<Class<M>, Class<D>> registry;
     ...
     */
    protected final Map<Class<M>, KittyMMEntry> modelMapperInstanceStorage = new HashMap<>();
    ...
    protected KittyDatabase(Context ctx, String databasePassword, String databaseFilepath, KittySchemaDefinition expectedDefinition) {
        ...
        final Map<Class<M>, KittyMMEntry> staticMap = getStaticModelMapperInstancesStorage();
        if(staticMap != null) {
     ...
     * @return
     */
    public static final int getDatabaseVersion(String databaseFilePath) {
     ...
     */
    protected KittyConfigurator getConfigurator(Context ctx, Map<Class<M>, Class<D>> registry, String databaseFilepath, int databaseVersion) {
     ...
     */
    protected Map<Class<M>, Class<D>> getStaticRegistry() {
        return null;
    }
    ...
    public final M getModel(Class<M> recordClass) {
    ...
    public final D getMapper(Class<M> recordClass) {
        if(modelMapperInstanceStorage.containsKey(recordClass)) {
    ...
    protected Map<Class<M>, KittyMMEntry> generateMMInstanceStorageFromRegistry(Map<Class<M>, Class<D>> registry,
        ...
        while (ktcItearator.hasNext()) {
            ...
            Class<D> dataMapperClass = registry.get(tableConfiguration.modelClass);
    ...
    public final void printRegistryToLog(KittyLog.LOG_LEVEL logLevel) {
        ...
        for(Map.Entry<Class<M>, Class<D>> registryEntry : registry.entrySet()) {
