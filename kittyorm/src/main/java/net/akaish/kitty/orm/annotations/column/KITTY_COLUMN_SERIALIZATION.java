...
@Inherited
public @interface KITTY_COLUMN_SERIALIZATION {
    // serialization and deserialization instructions
    //boolean useSD() default false;
    String deserializationMethodName() default ZERO_LENGTH_STRING;
    String serializationMethodName() default ZERO_LENGTH_STRING;
}
