...
public class Lesson7ContactsAndLicense  extends Fragment implements LessonFabBaseFragment, LessonHostFragment {

    LessonTabAdapter lesson7TabAdapter;
    private ViewPager viewPager;

    boolean initialFabDrawCall = true;

    public Lesson7ContactsAndLicense() {};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lesson7TabAdapter = new LessonTabAdapter(this, getChildFragmentManager());
        Fragment initialFragment = new Lesson7Tab1Contacts();
        lesson7TabAdapter.addFragment(initialFragment, getContext().getString(R.string._l7_tab_contact));
        lesson7TabAdapter.addFragment(new Lesson7Tab2License(), getContext().getString(R.string._l7_tab_legal_info));
        viewPager.setAdapter(lesson7TabAdapter);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                try {
                    LessonTabFragmentOnVisibleAction fragment = (LessonTabFragmentOnVisibleAction) lesson7TabAdapter.instantiateItem(viewPager, position);
                    if (fragment != null) {
                        fragment.onVisible();
                    }
                    ...
                    Log.w("KittyORM Demo", "Some error on tab pager, lesson 7", e);
                }
            }
    ...
    public RegularLessonBaseFragment getCurrentTabFragment() {
        return (RegularLessonBaseFragment) lesson7TabAdapter.currentFragment;
    }

    @Override
    public int getFragmentSpecificFabLayoutResource() {
        return lesson7TabAdapter.currentFragment.getFragmentSpecificFabLayoutResource();
    }

    @Override
    public LinkedList<FabContainer> getFragmentSpecificFabOnClickListeners() {
        return lesson7TabAdapter.currentFragment.getFragmentSpecificFabOnClickListeners();
    }

    @Override
    public LinkedList<Integer> getFragmentSpecificListOfFabsLayouts() {
        return lesson7TabAdapter.currentFragment.getFragmentSpecificListOfFabsLayouts();
    }
}
