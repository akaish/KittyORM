...
public class Lesson3DatatypesAndConstraints  extends Fragment implements LessonFabBaseFragment, LessonHostFragment {

    LessonTabAdapter lesson3TabAdapter;
    private ViewPager viewPager;

    boolean initialFabDrawCall = true;

    public Lesson3DatatypesAndConstraints() {};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lesson3TabAdapter = new LessonTabAdapter(this, getChildFragmentManager());
        Fragment initialFragment = new Lesson3Tab1DatatypesAffinities();
        lesson3TabAdapter.addFragment(initialFragment, getContext().getString(R.string._l3_tab_datatypes_affinities));
        lesson3TabAdapter.addFragment(new Lesson3Tab2Constraints(), getContext().getString(R.string._l3_tab_constatints_and_indexes));
        viewPager.setAdapter(lesson3TabAdapter);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                try {
                    LessonTabFragmentOnVisibleAction fragment = (LessonTabFragmentOnVisibleAction) lesson3TabAdapter.instantiateItem(viewPager, position);
                    if (fragment != null) {
                        fragment.onVisible();
                    }
    ...
    public RegularLessonBaseFragment getCurrentTabFragment() {
        return (RegularLessonBaseFragment) lesson3TabAdapter.currentFragment;
    }

    @Override
    public int getFragmentSpecificFabLayoutResource() {
        return lesson3TabAdapter.currentFragment.getFragmentSpecificFabLayoutResource();
    }

    @Override
    public LinkedList<FabContainer> getFragmentSpecificFabOnClickListeners() {
        return lesson3TabAdapter.currentFragment.getFragmentSpecificFabOnClickListeners();
    }

    @Override
    public LinkedList<Integer> getFragmentSpecificListOfFabsLayouts() {
        return lesson3TabAdapter.currentFragment.getFragmentSpecificListOfFabsLayouts();
    }
}
