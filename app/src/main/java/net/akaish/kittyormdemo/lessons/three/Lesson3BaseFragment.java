...
public abstract class Lesson3BaseFragment extends LessonBaseFragment implements LessonTabFragmentOnVisibleAction {
    ...
    KittyTutorialActivity getLessonActivity() {
        return ((Lesson3DatatypesAndConstraints)getParentFragment()).getLessonActiity();
    }
